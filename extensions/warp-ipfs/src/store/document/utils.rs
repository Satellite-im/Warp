...
//         match tokio::time::timeout(timeout, ipfs.get_dag(self.clone()).into_future()).await {
//             Ok(Ok(ipld)) => from_ipld(ipld)
//                 .map_err(anyhow::Error::from)
//                 .map_err(Error::from),
//             Ok(Err(e)) => Err(Error::Any(anyhow::Error::from(e))),
...
// #[async_trait::async_trait]
// pub(crate) trait GetLocalDag<D>: Sized + Send {
