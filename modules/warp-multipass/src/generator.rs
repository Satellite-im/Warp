...
pub fn generate_name() -> String {
    ...
    loop {
        let first = match adj().get(warp_crypto::rand::thread_rng().gen_range(0, adj_length)) {
            Some(s) => capitalize_first_letter(s),
            None => continue,
        };
        let second = match nouns().get(warp_crypto::rand::thread_rng().gen_range(0, nouns_length)) {
            Some(s) => capitalize_first_letter(s),
            None => continue,
        };
